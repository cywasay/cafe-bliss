...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="group relative bg-white/80 rounded-2xl border border-pink-100 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button className="bg-white/90 text-gray-800 px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-white transition-all">
            Quick View
          </button>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        {/* Wishlist Button */}
        <button className="w-full mt-2 px-4 py-2 border border-pink-200 text-gray-600 rounded-xl hover:bg-gradient-to-r hover:from-amber-50 hover:to-pink-50 hover:border-amber-300 transition-all font-medium">
          <div className="flex items-center justify-center gap-2">
            <svg
              className="w-4 h-4"
              fill="none"
